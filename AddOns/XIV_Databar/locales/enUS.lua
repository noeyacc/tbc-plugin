...
L['Open Clock'] = "Open Instance locked down";
...
L['Destiny 2'] = true;
L['Call of Duty: Black Ops 4'] = true;
L['Call of Duty: Modern Warfare'] = true;
L['Call of Duty: Modern Warfare 2'] = true;
L['Call of Duty: Black Ops Cold War'] = true;
