...
L['Show Menu Button'] = "Menu";
L['Show Chat Button'] = "Tchat";
L['Show Guild Button'] = "Guilde";
L['Show Social Button'] = "Contacts";
L['Show Character Button'] = "Personnage";
L['Show Spellbook Button'] = "Grimoire";
L['Show Talents Button'] = "Talents";
L['Show Achievements Button'] = "Haut-faits";
L['Show Quests Button'] = "Quêtes";
L['Show LFG Button'] = "Recherche de Gr -(P2)";
L['Show Journal Button'] = "Journal";
L['Show PVP Button'] = "PVP";
L['Show Pets Button'] = "Mascottes";
L['Show Shop Button'] = "Boutique";
L['Show Help Button'] = "Aide";
