...
function XIVBar:OnInitialize()
    ...
    self.optionsFrame = LibStub("AceConfigDialog-3.0"):AddToBlizOptions(AddOnName, L["XIV Bar"], nil, "general")

    --options.args.modules = LibStub("AceDBOptions-3.0"):GetOptionsTable(self.db)
    self.modulesOptionFrame = LibStub("AceConfigDialog-3.0"):AddToBlizOptions(AddOnName, L['Modules'], L["XIV Bar"], "modules")

    options.args.profiles = LibStub("AceDBOptions-3.0"):GetOptionsTable(self.db)
    self.profilesOptionFrame = LibStub("AceConfigDialog-3.0"):AddToBlizOptions(AddOnName, L['Profiles'], L["XIV Bar"], "profiles")
...
function XIVBar:ToggleConfig()
	...
	InterfaceOptionsFrame_OpenToCategory(L["XIV Bar"])
