...
L["versionOutOfDate"] = "你的<Nova Instance Tracker>插件已经过期了，请上https://www.curseforge.com/wow/addons/nova-instance-tracker 更新，或通过twitch客户端更新。";
L["Options"] = " 选项";
L["Reset Data"] = "重置资料"; --A button to Reset buffs window data.

L["Error"] = "错误";
L["delete"] = "删除";
L["confirmInstanceDeletion"] = "确认删除事件";
...
L["openInstanceLogFrameTitle"] = "开启事件纪录";

L["logSizeTitle"] = "纪录中显示多少事件";
L["logSizeDesc"] = "你想要在纪录中显示多少事件? 最多300条，预设为100条 (你可以输入 /NIT 显示纪录).";
...
L["instanceStatsTextDesc"] = "在这裡选择当你离开副本要在团队或是聊天视窗显示副本追踪讯息。";
...
L["instanceStatsOutputTimeDesc"] = "显示你在地城裡花了多少时间?";
...
L["show24HourOnlyDesc"] = "只显示最后24小时的事件纪录?";
...
L["enteredDungeon"] = "新的事件 %s %s, 点击";
L["enteredDungeon2"] = "如果这是一个新的副本纪录。";
...
L["nextInstanceAvailable"] = "下一个事件已可用";
L["gave"] = "支出";
L["received"] = "收到";
L["to"] = "给";
L["from"] = "从";
...
L["thisChar"] = "这隻角色";
L["yourChars"] = "你的角色";
L["instancesPastHour"] = "在过去这个小时的事件";
L["instancesPastHour24"] = "在过去24小时的事件";
...
L["instanceStatsOutputRepDesc"] = "显示在副本裡提升了多少声望。";
