...
local OptionsFrame = ExRT.Options:Add("Exorsus Raid Tools","|cffffa800"..L.addonname.."|r")
...
OptionsFrame.title = ELib:Text(OptionsFrame,L.addonname,28):Point("LEFT",OptionsFrame.image,"RIGHT",20,0):Color()
