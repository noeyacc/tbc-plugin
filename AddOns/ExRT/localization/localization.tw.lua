...
-- 11:19 04.02.2021  補充翻譯:：三皈依-暗影之月
...
L.NoteHelpAdv3 = "此範例將被替換為選定的首領戰鬥片段的動態計時器。計時器只有在手動啟動後才有效。使用聊天指令 \"|cffffff00/rt note starttimer customevent|r\" or lua function \"|cffffff00GExRT.F.Note_Timer(\"customevent\")|r\""
L.NoteHelpAdv4 = "此範例將被替換為選定的首領戰鬥片段的動態計時器。此條件將運行weakauras插件的自定義事件。事件名稱 - |cffffff00EXRT_NOTE_TIME_EVENT|r。事件將在計時器的20、15、10、5、4、3、2、1,0秒觸發。1參數是條件名稱 (|cffffff00nzoth_hs1|r 在此範例), 2參數 - 剩餘時間, 整數, 3參數 - 註記中的文字。"
...
L.RaidCheckNoAddonOptTooltip = "僅檢查帶有EXRT插件的玩家。 沒有插件的玩家將被標記為\"無插件\""
...
L.ChatwindowName = "報告 - ExRT 團隊工具包"
...
PH.LoggingStart = "ExRT: 開始內建戰鬥記錄"
PH.LoggingEnd = "ExRT: 停止內建戰鬥記錄"
...
L.WACheckerShareTooltip = "團隊中每個有更新 ExRT 插件版本的玩家都將會收到這個 WA"
