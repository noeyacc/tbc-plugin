...
function UnitFramesPlus_FocusExtraTextFontSize()
    FocusFrameTextureFrame.HealthBarText:SetFont(GameFontNormal:GetFont(), UnitFramesPlusDB["focus"]["barfontsize"], "OUTLINE");
    FocusFrameTextureFrame.HealthBarTextLeft:SetFont(GameFontNormal:GetFont(), UnitFramesPlusDB["focus"]["barfontsize"], "OUTLINE");
    FocusFrameTextureFrame.HealthBarTextRight:SetFont(GameFontNormal:GetFont(), UnitFramesPlusDB["focus"]["barfontsize"], "OUTLINE");
    FocusFrameTextureFrame.ManaBarText:SetFont(GameFontNormal:GetFont(), UnitFramesPlusDB["focus"]["barfontsize"], "OUTLINE");
    FocusFrameTextureFrame.ManaBarTextLeft:SetFont(GameFontNormal:GetFont(), UnitFramesPlusDB["focus"]["barfontsize"], "OUTLINE");
    FocusFrameTextureFrame.ManaBarTextRight:SetFont(GameFontNormal:GetFont(), UnitFramesPlusDB["focus"]["barfontsize"], "OUTLINE");

    UFP_FocusHPMPPctHP:SetFont(GameFontNormal:GetFont(), UnitFramesPlusDB["focus"]["ufpfontsize"], "OUTLINE");
    UFP_FocusHPMPPctMP:SetFont(GameFontNormal:GetFont(), UnitFramesPlusDB["focus"]["ufpfontsize"], "OUTLINE");
    UFP_FocusHPMPPctPct:SetFont(GameFontNormal:GetFont(), UnitFramesPlusDB["focus"]["ufpfontsize"], "OUTLINE");
    UFP_FocusRace:SetFont(GameFontNormal:GetFont(), UnitFramesPlusDB["focus"]["ufpfontsize"], "OUTLINE");

    FocusFrameTextureFrameName:SetFont(GameFontNormalSmall:GetFont(), UnitFramesPlusDB["focus"]["namefontsize"]);
end
