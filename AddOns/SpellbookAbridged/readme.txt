...
Version: 2.6.x
Supports WoW Classic Version 1.13.4

=== !WARNING! ===

This beta variant of 2.6.4 is the same as 2.6.4 with one exception.  In this variant, the 
Spellbook will not close or be locked out during combat.  The reason the spellbook was forced
close during combat was due to restricted functions not worked due to taint, causing weird
behavior during combat.

If you are having problems with the spellbook outside of combat, please install Version 2.6.4 
and try to recreate those problems.  As far as issues in combat, that is the limits that 
