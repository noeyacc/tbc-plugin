...
SlashCmdList["SBA"] = function (msg, editbox)
	...
	RankFilterButton:SetPoint("TOPLEFT", SpellBookFrame, "TOPLEFT", 70, -35);
	AutoUpRankButton:ClearAllPoints();
	AutoUpRankButton:SetPoint("TOPLEFT", SpellBookFrame, "TOPLEFT", 70, -55); 
end
...
function SpellBookAbridged_OnLoad(self)
	...
	getglobal(RankFilterButton:GetName() .. "Text"):SetText("隱藏低等級法術");
	getglobal(AutoUpRankButton:GetName() .. "Text"):SetText("自動升級快捷列上的法術");
...
function SBA_UpdateExampleButton(self)
	...
	spellString:SetText("法術名稱");

	self.SpellSubName:SetHeight(6);
	subSpellString:SetText("法術說明");
