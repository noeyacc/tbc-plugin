...
elseif locale == "zhTW" then --Taiwan is a part of China forever
    --Tips
	L["MAILLOGGER TIPS"] = "|cFFBA55D3MailLogger|r指令說明: 輸入|cFF00BFFF/maillogger|r |cFFFF4500gui|r或|cFF00BFFF/ml|r |cFFFF4500gui|r顯示設定視窗，輸入|cFF00BFFF/maillogger|r |cFFFF9000all|r或|cFF00BFFF/ml|r |cFFFF9000all|r顯示全部記錄，|cFF00BFFF/maillogger|r |cFFFF9000tl|r或|cFF00BFFF/ml|r |cFFFF9000tl|r顯示交易記錄，|cFF00BFFF/maillogger|r |cFFFF9000ml|r或|cFF00BFFF/ml|r |cFFFF9000ml|r顯示郵件記錄，|cFF00BFFF/maillogger|r |cFFFF9000all|r或|cFF00BFFF/ml|r |cFFFF9000sm|r顯示發件記錄，輸入|cFF00BFFF/maillogger|r |cFFFF9000all|r或|cFF00BFFF/ml|r |cFFFF9000rm|r顯示收件記錄。"
	--交易
	...
	L["Show |cFF4169E1Minimap Button|r"] = "顯示|cFF4169E1小地圖按鈕|r"
	L["Log |cFFFF7F50Every Day|r"] = "記錄|cFFFF7F50每一天|r"
	L["Enable |cFF00FFFFCalendar|r"] = "啓用|cFF00FFFF日曆過濾|r"
    ...
    L["Trade Log Days"] = "記錄保存天數"
    L["365 Days"] = "365天"
    L["Print Logs"] = "顯示記錄"
    L["Delete All"] = "清空記錄"
    L["Prevent Robot Trades Me"] = "阻止外掛腳本交易"
	...
	L["<|cFFBA55D3MailLogger|r>All other Alts was deleted!"] = "<|cFFBA55D3MailLogger|r>已刪除所有分身!"
    L["All Logs"] = "全部記錄"
    L["Trade Logs"] = "交易記錄"
    L["Mail Logs"] = "郵件記錄"
    L["Sent Mail"] = "發送記錄"
    ...
    L["|cFF00FF00Right Click|r to Open Config Frame"] = "|cFF00FF00右鍵|r打開設定選項"
