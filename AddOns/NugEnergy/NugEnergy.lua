...
NugEnergy.Commands = {
    ["gui"] = function(v)
        ...
        InterfaceOptionsFrame_OpenToCategory(L"NugEnergy")
        InterfaceOptionsFrame_OpenToCategory(L"NugEnergy")
    end,
    ["unlock"] = function(v)
...
function NugEnergy:CreateGUI()
    local opt = {
        type = 'group',
        name = L"NugEnergy Settings",
        order = 1,
        args = {
            unlock = {
                name = L"Unlock",
                type = "execute",
                desc = L"Unlock anchor for dragging",
                        ...
                        args = {
                            ...
                            borderType = {
                                ...
                                values = {
                                    ...
                                    ["2PX"] = L"2px Border",
                                    ["3PX"] = L"3px Border",
                                    ["TOOLTIP"] = L"Tooltip Border",
                                    ["STATUSBAR"] = L"Status Border",
                                },
                            },
                            spenderFeedback = {
                    ...
                    classResourceGroup = {
                        ...
                        args = {
                            ...
                            mana = {
                                ...
                                desc = L"Toggle for all other classes",
                                type = "toggle",
                                order = 5,
    ...
    local panelFrame = AceConfigDialog:AddToBlizOptions("NugEnergyOptions", L"NugEnergy")
