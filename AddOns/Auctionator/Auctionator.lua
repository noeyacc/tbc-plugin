...
function Atr_Duration_Initialize(self)
  ...
  Atr_Dropdown_AddPick (self, ZT("12 Hours"), 1, Atr_Duration_OnClick);
  Atr_Dropdown_AddPick (self, ZT("24 Hours"), 2, Atr_Duration_OnClick);
  Atr_Dropdown_AddPick (self, ZT("48 Hours"), 3, Atr_Duration_OnClick);
