...
AtrL["Slow scan"] = "慢速掃描"
AtrL["Level"] = "等級"
AtrL["Shopping list overwritten:"] = "購物清單已覆蓋"
AtrL["Shopping list created:"] = "已建立購物清單"
AtrL["Paste text that was previously exported into the text area to the left."] = ""
AtrL["Create new shopping lists with new names"] = "建立新的購物清單"
AtrL["Create new shopping lists with new names."] = ""
AtrL["Overwrite the existing shopping lists with the imported lists."] = "用導入的清單覆蓋現有的購物清單"
AtrL["Abort the import.  You can hand-edit the import text to change the names and then try again."] = "中止導入。 您可以手動編輯導入文字檔以更改名稱，然後再試一次"
AtrL["Click Select All, type Ctrl-C to copy the text and then paste into any text document."] = "單擊“全選”，鍵入Ctrl-C複製文本，然後貼上到任何文字檔中"
AtrL["%6d items"] = "" -- AUCTIONATOR_ITEMS_IN_THE_DATABASE %6d items description
AtrL["Default Auction duration"] = "預設拍賣時間"
AtrL["Options..."] = "設定選項..."
AtrL["More"] = ""
...
AtrL["Delete Shopping List"] = "刪除購物清單"
AtrL["Deposit"] = "保證金"
AtrL["Disenchant"] = "分解"
AtrL["Done"] = "完成"
...
AtrL["Minimum quality level:"] = "最低物品品質"
AtrL["More"] = "其他"
AtrL["Name for your new shopping list"] = "新的購物清單名稱"
AtrL["never"] = "永不"
AtrL["Never"] = "從未"
AtrL["New Shopping List"] = "新增購物清單"
AtrL["New"] = "新增"
...
AtrL["Rare"] = "精良"
AtrL["Really delete the shopping list %s ?"] = "真的要刪除購物清單 %s ?"
...
AtrL["48 Hours"] = "48 小時"
AtrL["24 Hours"] = "24 小時"
AtrL["If this option is checked, typing in the buy tab search bar will autocomplete from your history and shopping lists"] = "勾選時，在購入標籤頁面的搜尋框中輸入文字，會依據你的歷史記錄和購物清單來自動完成文字。"
AtrL["Enable AutoComplete"] = "啟用自動完成 (輸入中文有問題，請先不要勾選)"
AtrL["Show auction house week summary in tooltips"] = "滑鼠提示中顯示拍賣場每週摘要"
AtrL["Show auction house month summary in tooltips"] = "滑鼠提示中顯示拍賣場每月摘要"
AtrL["Show reagent prices in tradeskill tooltips"] = "在專業的滑鼠提示中顯示材料價格"
AtrL[" week"] = "(週)"
AtrL[" month"] = "(月)"
AtrL["No Data"] = "沒有資料"																										  
end
