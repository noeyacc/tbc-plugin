...
do -- private scope
    ...
    -- LOCALIZED STRINGS
    local SPIRIT_TAP_NAME = "精神分流"
    local BLESSING_OF_WISDOM_NAME = "智慧祝福"
    local GREATER_BLESSING_OF_WISDOM_NAME = "強效智慧祝福"
    local INNERVATE_NAME = "啟動"
    local DRINK_NAME = "喝水"
    local EVOCATION_NAME = "喚醒"
