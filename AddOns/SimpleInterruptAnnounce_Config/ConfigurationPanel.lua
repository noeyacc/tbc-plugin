...
local soundList = {
	'', '關閉',
	'Sound\\Doodad\\BellTollAlliance.ogg', '鐘聲 1',
	'Sound\\Doodad\\BellTollHorde.ogg', '鐘聲 2',
	'sound\\spells\\dynamiteexplode.ogg', '炸藥爆炸',
	'Sound\\SPELLS\\PetCall.ogg', '寵物哨子',
	'Sound\\character\\PlayerRoars\\CharacterRoarsDwarfMale.ogg', '矮人咆哮',
	'Sound\\character\\PlayerRoars\\CharacterRoarsOrcMale.ogg', '獸人咆哮',
	'sound\\creature\\murloc\\mmurlocaggroold.ogg', '魚人生氣',
	'Sound\\character\\EmoteCatCallWhistle05.ogg', '吹口哨',
	-- Custom sound files user can add to addon folder
	'Interface\\AddOns\\' .. addonName .. '\\sound1.mp3', '自訂的 sound1.mp3',
	'Interface\\AddOns\\' .. addonName .. '\\sound2.mp3', '自訂的 sound2.mp3',
	'Interface\\AddOns\\' .. addonName .. '\\sound1.ogg', '自訂的 sound1.ogg',
	'Interface\\AddOns\\' .. addonName .. '\\sound2.ogg', '自訂的 sound2.ogg',
}
...
function panel:Initialize()
	...
	local controlHeadingSolo = self:CreateHeading('單人時')
	...
	local controlHeadingGroup = self:CreateHeading('在隊伍中時')
	controlHeadingGroup:SetPoint('TOPLEFT', controlDropDownSoloOwn, 'BOTTOMLEFT', 0, -20)

	local controlDropDownGroupOwn = self:CreateDropDown(
		'自己的通報到',
		{ 'off', '關閉', 'self', '我自己', 'say', '說', 'party', '隊伍頻道' },
	...
	local controlHeadingRaid = self:CreateHeading('在團隊中時')
	...
	local controlDropDownRaidOwn = self:CreateDropDown(
		'自己的通報到',
		{ 'off', '關閉', 'self', '我自己', 'say', '說', 'party', '隊伍頻道', 'raid', '團隊頻道' },
