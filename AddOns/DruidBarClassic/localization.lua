...
if GetLocale() == "zhTW" then
	...
	DRUIDBAR_FORMX = "水棲";
	DRUIDBAR_FORMX2 = "旅行";
	BINDING_HEADER_DRUIDBAR = "德魯伊法力條"
	BINDING_NAME_DruidBarBest = "最佳形態";
	DRUIDBAR_REGEN1 = "裝備: 每 5 秒恢復 %d+ 點法力值。";
	DRUIDBAR_REGEN2 = "每 5 秒恢復 %d+ 點法力值。";
	DRUIDBAR_REGEN3 = "裝備: 每 5 秒恢復 (%d+) 點法力值。"
	DRUIDBAR_REGEN4 = "每 5 秒恢復 (%d+) 點法力值。";
	...
	DRUIDBAR_OPTIONS_Shift = "由任何形態變回人形";
	DRUIDBAR_OPTIONS_EZShift = "簡易變形";
	DRUIDBAR_OPTIONS_Debug = "除錯模式";
	DRUIDBAR_OPTIONS_ColorBar = "條顏色";
	DRUIDBAR_OPTIONS_ColorBack = "背景顏色";
	DRUIDBAR_OPTIONS_ColorBorder = "邊框顏色";
	DRUIDBAR_OPTIONS_Message_Mana = "法力條";
	DRUIDBAR_OPTIONS_Message_border = "邊框";
