...
local personalResourceBarBaseTopPadding = -230 -- units of space between center of screen downwards
...
StaticPopupDialogs["PRD_WRONG_SYNTAX"] = {
  text = "用法是: |cff3FD42A/prd <數值>|r\n數值必須為數字。\n預設值是: |cff3FD42A"..personalResourceBarBaseTopPadding.."|r\n輸入 |cff3FD42A/prd reset|r 來重置框架。",
  button1 = OKAY,
  hideOnEscape = 1,
  timeout = 0,
...
local PRD_personalHealthBar = CreateFrame("StatusBar", "PRD_personalHealthBar", UIParent)
  ...
  local PRD_personalHealthBarBorder = CreateFrame("Frame", "PRD_personalHealthBarBorder", PRD_personalHealthBar, BackdropTemplateMixin and "BackdropTemplate" or nil)
  ...
  local PRD_personalManaBarBorder = CreateFrame("Frame", "PRD_personalManaBarBorder", PRD_personalManaBar, BackdropTemplateMixin and "BackdropTemplate" or nil)
...
local function togglePercentage()
  ...
  if PRD_settingsConfig.showPercentage == false then
    ...
    _G["showReversePercentage_checkBoxText"]:SetText("|cff8e8e8c使用損失百分比")
  else
    _G["showReversePercentage_checkBoxText"]:SetText("使用損失百分比")
  end
...
local function PRD_resetFramesToDefault()
  PRD_personalHealthBar:SetScale(1.2)
  PRD_personalManaBar:SetScale(1.2)
  ...
  scale_Slider:SetValue(1.2)
  PRD_settingsConfig.scale = 1.2
...
local function PRD_moveVertically(toValue)
  ...
  _G[verticalPosition_Slider:GetName() .. 'Text']:SetText("垂直位置: |cfffdf457"..math.floor((ceil(toValue - .5)*100)/100))
...
local set = {}
  set.InterfaceOptions = CreateFrame("Frame", "PRD_InterfaceOptions", nil ,BackdropTemplateMixin and "BackdropTemplate" or nil) --Parent frame for all the settings frames
  set.InterfaceOptions.name = "個人資源條"
  ...
  set.InterfaceOptions.Title = set.InterfaceOptions:CreateFontString(nil, "ARTWORK", "GameFontNormalHugeOutline2")
    set.InterfaceOptions.Title:SetText("個人資源條")
  ...
  set.InterfaceOptions.Version = set.InterfaceOptions:CreateFontString(nil, "ARTWORK", "GameFontNormalOutline")
    set.InterfaceOptions.Version:SetText("ver. "..addonVersion.."\n".."類似魔獸世界正式版的顯示個人資源。作者: |cff3FD42ADi|cffFFFFFFopo|cffF50E09rc|r")
  ...
  function PRD_DropDown_init(frame, level, menuList)
    ...
    info.tooltipTitle = "設定個人資源條的框架層級。\n|cffffcc00"..frameStratas[1]..":|r 在所有其他介面的後方，只在遊戲世界 WorldFrame 的前面。\n|cffffcc00"..frameStratas[5]..":|r 在大部分其他插件和暴雪介面的前方，但是全螢幕過場動畫時無法看到。\n|cffffcc00"..frameStratas[7]..":|r 在所有其他介面的前方，包括全螢幕，例如世界地圖。"
  ...
  set.InterfaceOptions.editStrataFontString = set.InterfaceOptions:CreateFontString(nil, "ARTWORK", "GameFontNormalLargeOutline")
    set.InterfaceOptions.editStrataFontString:SetText("框架層級:")
  ...
  set.InterfaceOptions.showBorder_checkBox = CreateFrame("CheckButton", "showBorder_checkBox", set.InterfaceOptions, "ChatConfigCheckButtonTemplate")
    ...
    _G[set.InterfaceOptions.showBorder_checkBox:GetName().."Text"]:SetText("顯示邊框");
    showBorder_checkBox.tooltip = "兩個狀態條都要顯示邊框。"
  ...
  set.InterfaceOptions.hideMinimap_checkBox = CreateFrame("CheckButton", "hideMinimap_checkBox", set.InterfaceOptions, "ChatConfigCheckButtonTemplate")
    ...
    _G[set.InterfaceOptions.hideMinimap_checkBox:GetName().."Text"]:SetText("顯示小地圖按鈕");
    hideMinimap_checkBox.tooltip = "顯示小地圖按鈕。"
  ...
  set.InterfaceOptions.hideInCombat_checkBox = CreateFrame("CheckButton", "hideInCombat_checkBox", set.InterfaceOptions, "ChatConfigCheckButtonTemplate")
    ...
    _G[set.InterfaceOptions.hideInCombat_checkBox:GetName().."Text"]:SetText("非戰鬥中隱藏");
    hideInCombat_checkBox.tooltip = "沒有戰鬥時大幅降低框架的不透明度，不受溺水或火災等環境傷害的影響。"
  ...
  set.InterfaceOptions.hideHealthBar_checkBox = CreateFrame("CheckButton", "hideHealthBar_checkBox", set.InterfaceOptions, "ChatConfigCheckButtonTemplate")
    ...
    _G[set.InterfaceOptions.hideHealthBar_checkBox:GetName().."Text"]:SetText("隱藏血量條");
    hideHealthBar_checkBox.tooltip = "隱藏血量條。"
  ...
  set.InterfaceOptions.showPercentage_checkBox = CreateFrame("CheckButton", "showPercentage_checkBox", set.InterfaceOptions, "ChatConfigCheckButtonTemplate")
    ...
    _G[set.InterfaceOptions.showPercentage_checkBox:GetName().."Text"]:SetText("顯示百分比");
    showPercentage_checkBox.tooltip = "啟用狀態條旁的百分比文字。"
  ...
  set.InterfaceOptions.showReversePercentage_checkBox = CreateFrame("CheckButton", "showReversePercentage_checkBox", set.InterfaceOptions, "ChatConfigCheckButtonTemplate")
    ...
    -- _G[set.InterfaceOptions.showReversePercentage_checkBox:GetName().."Text"]:SetText("顯示損失百分比")
    showReversePercentage_checkBox.tooltip = "改為顯示失去血量/法力的百分比。"
  ...
  set.InterfaceOptions.dynamicHealthColor_checkBox = CreateFrame("CheckButton", "dynamicHealthColor_checkBox", set.InterfaceOptions, "ChatConfigCheckButtonTemplate")
    ...
    _G[set.InterfaceOptions.dynamicHealthColor_checkBox:GetName().."Text"]:SetText("動態血量顏色");
    dynamicHealthColor_checkBox.tooltip = "依據血量百分比更改血量條的顏色。"
  ...
  set.InterfaceOptions.scale_Slider = CreateFrame("Slider", "scale_Slider", set.InterfaceOptions, "OptionsSliderTemplate")
    ...
    scale_Slider.tooltipText = "控制框架的縮放大小。預設值 |cff66ff33(1.2)|r 會顯著標示為綠色。"
    ...
    scale_Slider:SetScript("OnValueChanged", function(self, value)
      ...
      _G[scale_Slider:GetName() .. 'Text']:SetText("縮放大小: |cfffdf457"..math.floor(value*100)/100)
      if value == 1.2 then
  ...
  set.InterfaceOptions.width_Slider = CreateFrame("Slider", "width_Slider", set.InterfaceOptions, "OptionsSliderTemplate")
    ...
    width_Slider.tooltipText = "控制框架的寬度。預設值 |cff66ff33("..personalResourceBarWidth..")|r 會顯著標示為綠色。"
    ...
    width_Slider:SetScript("OnValueChanged", function(self, value)
      ...
      _G[width_Slider:GetName() .. 'Text']:SetText("寬度 |cfffdf457"..math.floor((ceil(value - .5)*100)/100))
  ...
  set.InterfaceOptions.verticalPosition_Slider = CreateFrame("Slider", "verticalPosition_Slider", set.InterfaceOptions, "OptionsSliderTemplate")
    ...
    verticalPosition_Slider.tooltipText = "垂直移動框架。預設值 |cff66ff33("..personalResourceBarBaseTopPadding..")|r 會顯著標示為綠色。"
    _G[verticalPosition_Slider:GetName() .. 'Low']:SetText(""..minVerticalPosition)
    _G[verticalPosition_Slider:GetName() .. 'High']:SetText(""..maxVerticalPosition)
  ...
  set.InterfaceOptions.opacity_Slider = CreateFrame("Slider", "opacity_Slider", set.InterfaceOptions, "OptionsSliderTemplate")
    ...
    opacity_Slider.tooltipText = "調整非戰鬥中框架的不透明度。預設值: |cff66ff33"..defaultOpacityOOC
    ...
    opacity_Slider:SetScript("OnValueChanged", function(self, value)
      _G[opacity_Slider:GetName() .. 'Text']:SetText("非戰鬥中不透明度:\n|cfffdf457"..PRD_round(value, 1))
  ...
  local resetToDefault_button = CreateFrame("Button", "resetToDefault_button", set.InterfaceOptions)
    ...
    resetToDefault_button:SetScript("OnEnter", function(self)
        ...
        GameTooltip:AddLine("重置寬度、縮放大小和垂直位置，恢復為預設值。", 1, 0.79, 0.1, 1)
        GameTooltip:Show()
    end)
...
function PRD_onPlayerResourceChange(self, event, ...)
  ...
  elseif (event == "ADDON_LOADED") then
    ...
    if select(1, ...) == "Personal Resource Display" then
      ...
      _G[scale_Slider:GetName() .. 'Text']:SetText("縮放大小 |cfffdf457"..math.floor(PRD_settingsConfig.scale*100)/100)

      width_Slider:SetValue(PRD_settingsConfig.width)
      _G[width_Slider:GetName() .. 'Text']:SetText("寬度 |cfffdf457"..math.floor(PRD_settingsConfig.width*100)/100)

      verticalPosition_Slider:SetValue(PRD_settingsConfig.verticalPosition)
      _G[verticalPosition_Slider:GetName() .. 'Text']:SetText("垂直位置 |cfffdf457"..math.floor(PRD_settingsConfig.verticalPosition*100)/100)
      ...
      showReversePercentage_checkBox:SetEnabled(PRD_settingsConfig.showPercentage)
      if PRD_settingsConfig.showPercentage == false then
        _G[set.InterfaceOptions.showReversePercentage_checkBox:GetName().."Text"]:SetText("|cff8e8e8c使用損失百分比")
      else
        _G[set.InterfaceOptions.showReversePercentage_checkBox:GetName().."Text"]:SetText("使用損失百分比")
      end
...
MinimapButton:SetScript("OnEnter", function(self)
  ...
  GameTooltip:AddLine("|cffff4d4d個人資源條|r")
  GameTooltip:AddLine("|cff66ff33左鍵|r 開啟/關閉血量和法力框架\n|cff66ff33中鍵|r 隱藏小地圖按鈕 (可以從介面設定選項中顯示)")
  GameTooltip:AddLine("|cff66ff33右鍵|r 開啟/關閉插件設定\n|cff66ff33Shift+右鍵|r 重置框架為預設值")
  GameTooltip:AddLine("|cff66ff33/prd <數值>|r 垂直移動狀態條\n<數值> 是與畫面中心點的距離\n預設值為: |cffff4d4d"..personalResourceBarBaseTopPadding.."|r")
  GameTooltip:AddLine("|cff66ff33/prd reset|r 也會將框架重置為預設值")
  GameTooltip:AddLine("|cff66ff33/prd|r 開啟設定選項")
  GameTooltip:Show()
end)
...
MinimapButton:SetScript("OnClick", function(self, button)
  ...
  elseif button == "RightButton" then
    if isModKeyDown() then PRD_resetFramesToDefault() else
      if InterfaceOptionsFrame:IsVisible() then HideUIPanel(InterfaceOptionsFrame) else InterfaceOptionsFrame_OpenToCategory(set.InterfaceOptions); InterfaceOptionsFrame_OpenToCategory(set.InterfaceOptions) end
    end    
  end
